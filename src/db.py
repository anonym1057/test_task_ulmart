...
class DataBaseMonitoring():
    ...
    def __init__(self):
        ...
        if not os.path.isfile(os.path.join(settings.path_sqlite, f"{settings.name_database}.sqlite")):
            self.db = self.get_db(os.path.join(settings.path_sqlite, settings.path_sqlite))
